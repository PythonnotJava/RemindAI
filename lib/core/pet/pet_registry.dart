...
const _builtinSprites = <PetSpriteSheet>[
  PetSpriteSheet(
    ...
    animations: [
      ...
      SpriteAnimation(name: 'yawn', startRow: 3, frameCount: 10, fps: 6, loop: false),
      SpriteAnimation(name: 'sit', startRow: 4, frameCount: 4, fps: 3),
      SpriteAnimation(name: 'walk', startRow: 6, frameCount: 8, fps: 8, direction: SpriteDirection.right),
      SpriteAnimation(name: 'run', startRow: 8, frameCount: 6, fps: 10, direction: SpriteDirection.right),
      SpriteAnimation(name: 'sleep', startRow: 12, frameCount: 2, fps: 2),
      SpriteAnimation(name: 'jump', startRow: 20, frameCount: 8, fps: 10, loop: false),
      SpriteAnimation(name: 'interact', startRow: 24, frameCount: 8, fps: 8, loop: false),
      SpriteAnimation(name: 'happy', startRow: 28, frameCount: 3, fps: 5, loop: false),
      SpriteAnimation(name: 'climb', startRow: 36, frameCount: 9, fps: 8),
      SpriteAnimation(name: 'stretch', startRow: 38, frameCount: 7, fps: 6, loop: false),
    ],
  ),
  // 橘色猫
  PetSpriteSheet(
