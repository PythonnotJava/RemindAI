...
class PetShop {
  ...
  static const List<PetFoodItem> catalog = [
    ...
    PetFoodItem(
      id: 'banana',
      nameKey: 'petFoodBanana',
      descKey: 'petFoodBananaDesc',
      spriteCol: 0,
      spriteRow: 0,
      price: 3,
      satietyRestore: 8,
    ...
    PetFoodItem(
      id: 'apple',
      nameKey: 'petFoodApple',
      descKey: 'petFoodAppleDesc',
      spriteCol: 1,
      spriteRow: 0,
      price: 3,
      satietyRestore: 8,
    ...
    PetFoodItem(
      id: 'purple_grape',
      nameKey: 'petFoodPurpleGrape',
      descKey: 'petFoodPurpleGrapeDesc',
      spriteCol: 2,
      spriteRow: 0,
      price: 5,
      satietyRestore: 6,
    ...
    PetFoodItem(
      id: 'green_grape',
      nameKey: 'petFoodGreenGrape',
      descKey: 'petFoodGreenGrapeDesc',
      spriteCol: 3,
      spriteRow: 0,
      price: 5,
      satietyRestore: 6,
    ...
    PetFoodItem(
      id: 'pineapple',
      nameKey: 'petFoodPineapple',
      descKey: 'petFoodPineappleDesc',
      spriteCol: 0,
      spriteRow: 1,
      price: 8,
      satietyRestore: 12,
    ...
    PetFoodItem(
      id: 'cherry',
      nameKey: 'petFoodCherry',
      descKey: 'petFoodCherryDesc',
      spriteCol: 2,
      spriteRow: 1,
      price: 10,
      satietyRestore: 5,
      happinessBoost: 15,
      specialEffect: 'happy_dance',
    ),
    PetFoodItem(
      id: 'strawberry',
      nameKey: 'petFoodStrawberry',
      descKey: 'petFoodStrawberryDesc',
      spriteCol: 3,
      spriteRow: 1,
      price: 10,
      satietyRestore: 8,
    ...
    PetFoodItem(
      id: 'carrot',
      nameKey: 'petFoodCarrot',
      descKey: 'petFoodCarrotDesc',
      spriteCol: 0,
      spriteRow: 2,
      price: 4,
      satietyRestore: 12,
    ...
    PetFoodItem(
      id: 'tomato',
      nameKey: 'petFoodTomato',
      descKey: 'petFoodTomatoDesc',
      spriteCol: 1,
      spriteRow: 2,
      price: 4,
      satietyRestore: 10,
    ...
    PetFoodItem(
      id: 'eggplant',
      nameKey: 'petFoodEggplant',
      descKey: 'petFoodEggplantDesc',
      spriteCol: 2,
      spriteRow: 2,
      price: 4,
      satietyRestore: 12,
    ...
    PetFoodItem(
      id: 'pumpkin',
      nameKey: 'petFoodPumpkin',
      descKey: 'petFoodPumpkinDesc',
      spriteCol: 3,
      spriteRow: 2,
      price: 6,
      satietyRestore: 20,
    ...
    PetFoodItem(
      id: 'broccoli',
      nameKey: 'petFoodBroccoli',
      descKey: 'petFoodBroccoliDesc',
      spriteCol: 0,
      spriteRow: 3,
      price: 5,
      satietyRestore: 15,
    ...
    PetFoodItem(
      id: 'garlic',
      nameKey: 'petFoodGarlic',
      descKey: 'petFoodGarlicDesc',
      spriteCol: 1,
      spriteRow: 3,
      price: 3,
      satietyRestore: 5,
    ...
    PetFoodItem(
      id: 'pepper',
      nameKey: 'petFoodPepper',
      descKey: 'petFoodPepperDesc',
      spriteCol: 2,
      spriteRow: 3,
      price: 6,
      satietyRestore: 3,
    ...
    PetFoodItem(
      id: 'mushroom',
      nameKey: 'petFoodMushroom',
      descKey: 'petFoodMushroomDesc',
      spriteCol: 3,
      spriteRow: 3,
      price: 7,
      satietyRestore: 12,
    ...
    PetFoodItem(
      id: 'chicken',
      nameKey: 'petFoodChicken',
      descKey: 'petFoodChickenDesc',
      spriteCol: 1,
      spriteRow: 4,
      price: 20,
      satietyRestore: 30,
    ...
    PetFoodItem(
      id: 'lobster',
      nameKey: 'petFoodLobster',
      descKey: 'petFoodLobsterDesc',
      spriteCol: 3,
      spriteRow: 4,
      price: 50,
      satietyRestore: 40,
...
final List<PetAchievement> allAchievements = [
  PetAchievement(
    id: 'first_coin',
    nameKey: 'petAchieveFirstCoin',
    descKey: 'petAchieveFirstCoinDesc',
    icon: '\u{1F4B0}',
    check: (data) => data.totalEarned >= 1,
  ),
  PetAchievement(
    id: 'rich_100',
    nameKey: 'petAchieveRich100',
    descKey: 'petAchieveRich100Desc',
    icon: '\u{1F4B5}',
    check: (data) => data.totalEarned >= 100,
  ),
  PetAchievement(
    id: 'rich_500',
    nameKey: 'petAchieveRich500',
    descKey: 'petAchieveRich500Desc',
    icon: '\u{1F3E6}',
    check: (data) => data.totalEarned >= 500,
  ),
  PetAchievement(
    id: 'rich_2000',
    nameKey: 'petAchieveRich2000',
    descKey: 'petAchieveRich2000Desc',
    icon: '\u{1F451}',
    check: (data) => data.totalEarned >= 2000,
  ),
  PetAchievement(
    id: 'first_feed',
    nameKey: 'petAchieveFirstFeed',
    descKey: 'petAchieveFirstFeedDesc',
    icon: '\u{1F41F}',
    check: (data) => data.totalFeedCount >= 1,
  ),
  PetAchievement(
    id: 'feed_10',
    nameKey: 'petAchieveFeed10',
    descKey: 'petAchieveFeed10Desc',
    icon: '\u{1F372}',
    check: (data) => data.totalFeedCount >= 10,
  ),
  PetAchievement(
    id: 'feed_50',
    nameKey: 'petAchieveFeed50',
    descKey: 'petAchieveFeed50Desc',
    icon: '\u{1F3C5}',
    check: (data) => data.totalFeedCount >= 50,
  ),
  PetAchievement(
    id: 'full_belly',
    nameKey: 'petAchieveFullBelly',
    descKey: 'petAchieveFullBellyDesc',
    icon: '\u{1F60B}',
    check: (data) => data.satiety >= 100,
  ),
  PetAchievement(
    id: 'happy_max',
    nameKey: 'petAchieveHappyMax',
    descKey: 'petAchieveHappyMaxDesc',
    icon: '\u{1F63A}',
    check: (data) => data.happiness >= 100,
  ),
  PetAchievement(
    id: 'shopper',
    nameKey: 'petAchieveShopper',
    descKey: 'petAchieveShopperDesc',
    icon: '\u{1F381}',
    check: (data) => data.totalPurchaseCount >= 20,
  ),
  PetAchievement(
    id: 'chat_1m',
    nameKey: 'petAchieveChat1m',
    descKey: 'petAchieveChat1mDesc',
    icon: '\u{1F4AC}',
    check: (data) => data.totalTokensSpent >= 1000000,
  ),
  PetAchievement(
    id: 'chat_50m',
    nameKey: 'petAchieveChat50m',
    descKey: 'petAchieveChat50mDesc',
    icon: '\u{1F9E0}',
    check: (data) => data.totalTokensSpent >= 50000000,
  ),
  PetAchievement(
    id: 'chat_100m',
    nameKey: 'petAchieveChat100m',
    descKey: 'petAchieveChat100mDesc',
    icon: '\u{1F916}',
    check: (data) => data.totalTokensSpent >= 100000000,
  ),
];
  ...
  factory PetEconomyData.fromJson(Map<String, dynamic> json) {
    return PetEconomyData(
      ...
      unlockedAchievements:
          (json['unlockedAchievements'] as List<dynamic>?)?.cast<String>() ??
          [],
    );
  }
}
...
class PetEconomy extends ChangeNotifier {
  ...
  void _applyDecay() {
    ...
    final hoursPassed = now.difference(_data.lastDecayTime).inMinutes / 60.0;
