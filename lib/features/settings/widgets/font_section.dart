...
class _CustomFontsCard extends ConsumerWidget {
  ...
  Future<void> _removeFont(
      BuildContext context, WidgetRef ref, String font) async {
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            const SizedBox(height: 12),
            _buildFontDropdown(currentFont, allFonts, customFonts, onFontChanged),
            const SizedBox(height: 12),
            // 预览
            Container(
...
Widget _buildFontDropdown(
  ...
  final effectiveFont = allFonts.contains(currentFont) ? currentFont : allFonts.first;
            ...
            return DropdownMenuItem(
              ...
              child: Row(
                ...
                children: [
                  ...
                  Flexible(child: Text(font, style: style, overflow: TextOverflow.ellipsis)),
                ],
              ),
            );
          }).toList(),
