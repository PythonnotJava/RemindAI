      ...
      items: [
        ...
        PopupMenuItem(
          ...
          child: ListTile(
            ...
            title: Text(
              hasFood ? context.s.petFeedButton : context.s.petFeedButtonEmpty,
        ...
        const PopupMenuDivider(),
        ...sprites.map(
          (sprite) => PopupMenuItem(
            value: 'sprite:${sprite.id}',
            child: ListTile(
              dense: true,
              leading: Icon(
                sprite.id == _engine.sprite.id
...
class FloatingPetController {
  ...
  final ValueNotifier<Offset> positionNotifier = ValueNotifier(
