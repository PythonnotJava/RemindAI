...
class HtmlVisualizationCard extends StatefulWidget {
  ...
  @override
  State<HtmlVisualizationCard> createState() => _HtmlVisualizationCardState();
}

class _HtmlVisualizationCardState extends State<HtmlVisualizationCard> {
  ...
  Future<void> _initWebView() async {
    try {
      ...
      if (await file.exists()) {
        // 使用 file:// 协议加载本地文件，避免跨域限制和资源路径问题
        // Plotly/Bokeh/Altair 生成的 HTML 是完整的独立文件，包含内嵌的 JS/CSS
      ...
      print('[HtmlVisualizationCard] WebView2 初始化失败: $e');
      if (mounted) {
        setState(() {
          _failed = true;
          _error = e.toString();
